...
public class Person {
    ...
    /**
     * This method will print out the gender of person and include the supplied id.
     *
     * @param id
     * @param thePerson
     */
    public static void printGender(String id, Person thePerson) {
        System.out.println(id + " is a " + thePerson.getGender());
    }

    public void printGenderInstance(String id, Person thePerson) {
        System.out.println(id + " is a " + thePerson.getGender());
    }
